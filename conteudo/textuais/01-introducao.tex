...
O Quadro~\ref{quad:custo} apresenta a estimativa de custo da solução proposta em comparação com modelos comerciais de entrada, demonstrando a vantagem econômica da abordagem DIY com SBC.
...
\begin{quadro}[htb]
    ...
    \begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}X|c|c|c|}
        ...
        \hline
        \hline
        Hardware & Radxa ROCK 4B+ & \textit{Bay} 1 (integrado) & \textit{Bay} 1 (integrado) \\
        \hline
        ...
        \hline
        Sistema & OMV + Nextcloud + Tailscale & DSM (Synology) & QTS (QNAP) \\
        \hline
        Nuvem privada & Incluso (Nextcloud) & Não incluso & Não incluso \\
        \hline
        Acesso remoto & Incluso (Tailscale) & QuickConnect & myQNAPcloud \\
        \hline
...
\begin{figure}[htb]
    \centering
    \legenda[fig:custo]{COMPARAÇÃO GRÁFICA DE CUSTO ENTRE SOLUÇÕES}
    \begin{tikzpicture}
        \begin{axis}[
            ybar,
            xtick={1,2,3},
