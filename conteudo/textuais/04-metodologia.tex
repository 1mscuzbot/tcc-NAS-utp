...
A ordem de montagem segue o fluxo: conexão dos adaptadores USB-SATA ao \textit{hub} USB, conexão do \textit{hub} à \textit{ROCK 4B+}, inserção dos SSDs nos adaptadores, conexão do cabo de rede e da fonte de alimentação.
...
\begin{quadro}[!h]
    ...
    \begin{tabularx}{\linewidth}{|c|>{\raggedright\arraybackslash}X|}
        ...
        \hline
        2 & Inicialização da \textit{ROCK 4B+} e configuração de rede (IP fixo) \\
        \hline
